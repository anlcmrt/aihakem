...
export default function Register() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Firebase Auth profilini güncelle (username displayName olarak)
      if (auth.currentUser) {
      ...
      // Firestore'a kullanıcı adı kaydı
  ...
  return (
    <div className="max-w-md mx-auto mt-12 p-6 bg-white rounded-md shadow-md">
      ...
      {success && <p className="mb-4 text-green-600 font-semibold">Kayıt başarılı! Yönlendiriliyorsunuz...</p>}
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label htmlFor="username" className="block mb-1 font-semibold">Kullanıcı Adı</label>
          <input
            type="text"
            id="username"
            name="username"
